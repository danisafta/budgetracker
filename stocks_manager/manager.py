...
def get_financial_data(tickers: list, start_date='2000-01-01', end=None):
    ...
    for t in tickers:
        stock_data[t] = wb.DataReader(t, data_source='yahoo', start=start_date)['Adj Close']
    return stock_data
...
def get_portfolio_summary():
    ...
    print("Your portfolio has " + str(round(volatily * 100, 2)) + " % volatility and " + str(
        round(variance * 100, 2)) + " % variance ".format(volatily, variance))
